(function($){
    ...
    $.jSlots = function(el, options){
        ...
        $.jSlots.defaultOptions = {
            ...
            winnerNumber : 3,    // Number or Array: list item number(s) upon which to trigger a win, 1-based index, NOT ZERO-BASED
        ...
        base.Slot = function() {
            ...
            this.spinSpeed = 0.5;
            this.el = base.$el.clone().appendTo(base.$wrapper)[1000];
            this.$el = $(this.el);
            this.loopCount = 6;
            this.number = 1;
